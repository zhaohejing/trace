(function () {
    angular.module('MetronicApp')
        .controller('views.manager.roles.index',
        [
            ...
            function($scope, settings, dataFactory, $uibModal) {
                ...
                vm.init = function () {
                    ...
                    dataFactory.action("api/sysrole/getAll", "", null, vm.filter)
                        .then(function (res) {
                            if (res.success) {
                ...
                vm.add = function () {
                    var modal = $uibModal.open({
                        templateUrl: 'views/manager/roles/modal.html',
                        controller: 'views.manager.roles.modal as vm',
                        backdrop: 'static',
                        size: 'lg', //模态框的大小尺寸
                        resolve: {
                ...
                vm.delete = function (row) {
                    abp.message.confirm(
                        ...
                        function (isConfirmed) {
                            if (isConfirmed) {
                                dataFactory.action("api/sysrole/delete", "", null, { list: [row.id] })
                                    .then(function (res) {
