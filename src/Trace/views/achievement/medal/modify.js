    ...
    angular.module('MetronicApp').controller('views.achievement.medal.modify',
        ...
        function ($scope, settings, $uibModal, $state, $stateParams, dataFactory, appSession, $qupload) {
            ...
            vm.achilist= {
                list: [],
                init: function() {
                    dataFactory.action("api/product/badgeList", "", null, { pageNum: 1, pageSize: 999 })
               .then(function (res) {
                   if (res.success) {
            ...
            vm.choose= function() {
                var modal = $uibModal.open({
                    templateUrl: 'views/achievement/medal/choose.html',
                    controller: 'views.achievement.medal.choose as vm',
                    backdrop: 'static',
                    size: 'lg', //模态框的大小尺寸
                    resolve: {
